...
SKILLs for the MetaMask Agent CLI (`@metamask/agent-wallet` v6.1.2). These skills enable AI agents to authenticate, manage wallets, swap tokens, bridge across chains, trade perpetual futures, earn yield on DeFi vaults, and more using the MetaMask Agent CLI.
