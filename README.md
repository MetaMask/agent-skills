...
SKILLs for the MetaMask Agent CLI (`@metamask/agentic-cli` v5.3.0). These skills enable AI agents to authenticate, manage wallets, swap tokens, bridge across chains, trade perpetual futures, earn yield on DeFi vaults, and more using the MetaMask Agent CLI.
