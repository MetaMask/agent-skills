...
```bash
mm-dev token list popular --chain 1mm-dev token list trending --chain 1mm-dev token list top-gainer --chain 1```
...
```bash
mm-dev price spot --asset-ids "eip155:1/slip44:60"mm-dev price spot --asset-ids "eip155:1/slip44:60,eip155:137/slip44:966" --vs eur --market-data```
